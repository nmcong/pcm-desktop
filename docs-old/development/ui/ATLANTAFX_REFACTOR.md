...
PCM Desktop đã được refactor toàn bộ để sử dụng **AtlantaFX** design system, theo best practices từ AtlantaFX Sampler.
Thiết kế mới hiện đại, nhất quán và dễ maintain hơn.
