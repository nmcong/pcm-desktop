 ...
 *
 * <p>Represents a single message from user or AI assistant. Follows: - Single Responsibility
 * Principle (only message data) - Builder Pattern for construction - Immutable after creation (use
 * setters carefully)
 *
 * @author PCM Team
 * @version 1.0.0
