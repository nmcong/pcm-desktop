 ...
 * 
 * Follows:
 * - Single Responsibility Principle (only conversation data)
 * - Builder Pattern for construction
 * - Aggregate Root in DDD (manages Messages)
 * 
 * @author PCM Team
 * @version 1.0.0
 */
...
public class Conversation extends BaseEntity {
    ...
    public void addMessage(Message message) {
        ...
        if (this.preview == null && message.isFromUser()) {
            this.preview = message.getContent().length() > 100 
     ...
     */
    public static Conversation create(String title, String userId, String llmProvider, String llmModel) {
