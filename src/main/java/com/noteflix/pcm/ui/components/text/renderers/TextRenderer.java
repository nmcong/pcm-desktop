...
/**
 * Interface for rendering different types of text content. Each renderer is responsible for
 * converting text content into a JavaFX Node that can be displayed in the UI.
 */
public interface TextRenderer {
  ...
  /**
   * Check if this renderer supports live updates (i.e., can re-render content efficiently when text
   * changes)
   *
