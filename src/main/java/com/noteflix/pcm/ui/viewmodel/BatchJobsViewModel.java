...
public class BatchJobsViewModel extends BaseViewModel {
  ...
  public void loadJobs() {
    ...
    runAsync(() -> {
      ...
      jobList.setAll(jobs);
      updateStats();
      setLastRefreshTime(java.time.LocalDateTime.now().format(java.time.format.DateTimeFormatter.ofPattern("HH:mm:ss")));
  ...
  public void setTotalJobs(int totalJobs) { this.totalJobs.set(totalJobs); }

  public int getRunningJobs() { return runningJobs.get(); }
  public IntegerProperty runningJobsProperty() { return runningJobs; }
  public void setRunningJobs(int runningJobs) { this.runningJobs.set(runningJobs); }

  public int getFailedJobs() { return failedJobs.get(); }
  public IntegerProperty failedJobsProperty() { return failedJobs; }
  public void setFailedJobs(int failedJobs) { this.failedJobs.set(failedJobs); }

  public String getLastRefreshTime() { return lastRefreshTime.get(); }
  public StringProperty lastRefreshTimeProperty() { return lastRefreshTime; }
  public void setLastRefreshTime(String lastRefreshTime) { this.lastRefreshTime.set(lastRefreshTime); }

  public ObservableList<JobEntry> getJobList() { return jobList; }
  ...
  public static class JobEntry {
    ...
    public void setLastRun(String lastRun) { this.lastRun.set(lastRun); }
