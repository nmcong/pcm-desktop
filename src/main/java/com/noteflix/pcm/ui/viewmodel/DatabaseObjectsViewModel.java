...
public class DatabaseObjectsViewModel extends BaseViewModel {
    ...
    public final StringProperty connectionStatus =
            new SimpleStringProperty(I18n.get("db.status.disconnected"));
    ...
    public StringProperty schemaVersionProperty() {
        return schemaVersion;
    }

    public ObservableList<String> getSchemaObjects() {
        return schemaObjects;
    }

    public String getSelectedObjectDetails() {
        return selectedObjectDetails.get();
    }

    public void setSelectedObjectDetails(String selectedObjectDetails) {
        this.selectedObjectDetails.set(selectedObjectDetails);
    }

    public StringProperty selectedObjectDetailsProperty() {
