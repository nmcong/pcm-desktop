...
public class UniversalTextDemoPage extends BasePage {
    ...
    protected VBox createMainContent() {
        ...
        // Setup callbacks
        textComponent.setOnContentChanged(newContent -> {
            log.info("Content changed: {} characters", newContent.length());
        });
        
        textComponent.setOnContentTypeChanged(newType -> {
            log.info("Content type changed to: {}", newType);
        });
        
        textComponent.setOnViewModeChanged(newMode -> {
    ...
    private HBox createControls() {
        ...
        controls.getChildren().addAll(
            sampleLabel, sampleSelector,
            new Separator(),
            loadMarkdownBtn, loadCodeBtn, loadPlainBtn,
            new Separator(),
            toggleModeBtn
        );
    ...
    public enum SampleContent {
        MARKDOWN_SAMPLE("Markdown Sample", TextContentType.MARKDOWN, """
        ...
        CODE_SAMPLE("Java Code Sample", TextContentType.CODE, """
        ...
        PLAIN_TEXT_SAMPLE("Plain Text Sample", TextContentType.PLAIN_TEXT, """
        ...
        MERMAID_SAMPLE("Mermaid Diagram", TextContentType.MERMAID, """
            graph TD
