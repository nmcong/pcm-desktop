 ...
 *
 * <p>Responsibilities: - Manage database connections - Ensure single instance (Singleton) - Handle
 * connection lifecycle
 *
 * <p>Thread-safe implementation using enum singleton pattern
 */
@Slf4j
public enum ConnectionManager {
  ...
  /**
   * Get database connection Creates new connection if not exists or closed
   *
