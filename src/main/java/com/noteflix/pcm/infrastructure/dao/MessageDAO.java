 ...
 *
 * <p>Handles direct SQL operations for messages table.
 *
 * @author PCM Team
 * @version 1.0.0
 */
...
public class MessageDAO implements DAO<Message, Long> {
    ...
    private static final String INSERT_SQL =
            "INSERT INTO "
                    + TABLE_NAME
                    + " (conversation_id, role, content, function_name, "
    ...
    private static final String UPDATE_SQL =
            "UPDATE "
                    + TABLE_NAME
                    + " SET conversation_id = ?, role = ?, content = ?, function_name = ?, function_arguments"
                    + " = ?, token_count = ?, metadata = ?, updated_at = ? WHERE id = ?";
    ...
    public List<Message> readByConversationId(Long conversationId, Connection connection)
            throws SQLException {
        List<Message> messages = new ArrayList<>();
    ...
    public void deleteByConversationId(Long conversationId, Connection connection)
            throws SQLException {
