 ...
 * 
 * Provides callbacks for all stages of LLM communication:
 * - Token streaming (for real-time display)
 * - Thinking process (for reasoning models like o1/o3)
 * - Tool calls (when LLM wants to use a function)
 * - Completion (when response is done)
 * - Errors (when something goes wrong)
 * 
 * This enables rich UI integration with progress indicators,
...
public interface ChatEventListener {
     ...
     * Only called during streaming responses.
     * 
    ...
    /**
     * Called when a thinking token is received (for reasoning models).
     * This is the internal reasoning process, not the final answer.
     * 
    ...
    /**
     * Called when the LLM requests a tool/function call.
     * May be called multiple times if LLM requests multiple tools.
     * 
     ...
     * Contains the full response with all metadata.
     * 
