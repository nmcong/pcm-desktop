 ...
 * - Interface Segregation: Separated from base LLMClient interface
 *   Only providers that support streaming need to implement this
 * - Open/Closed: New streaming methods can be added without modifying base interface
 * 
 * Design Pattern: Observer Pattern
 * Observers are notified as chunks arrive
 * 
 * Usage:
...
public interface StreamingCapable {
     ...
     * 
     * This method returns a Stream that yields chunks as they arrive.
     * The stream will complete when the response is finished.
     * 
     * Example:
     * <pre>
     ...
     * 
     * This method uses callbacks instead of Stream API.
     * Better for UI integration where you want callbacks.
     * 
     * Example:
     * <pre>
     ...
     * May depend on configuration or model
     * 
