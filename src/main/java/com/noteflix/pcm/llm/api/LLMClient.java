 ...
 *
 * <p>Follows SOLID principles: - Single Responsibility: Only defines contract for LLM communication
 * - Interface Segregation: Base interface with minimal methods - Dependency Inversion: High-level
 * code depends on this abstraction
 *
 * <p>Design Pattern: Strategy Pattern Different LLM providers implement this interface as different
 * strategies
 *
 * @author PCM Team
 * @version 1.0.0
