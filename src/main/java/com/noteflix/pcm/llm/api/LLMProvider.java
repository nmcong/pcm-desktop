 ...
 * 
 * All LLM providers (OpenAI, Anthropic, Ollama, etc.) implement this interface,
 * providing a consistent API for:
 * - Chat completion (with/without streaming)
 * - Function/tool calling
 * - Token counting
 * - Provider capabilities
 * - Model listing
 * 
 * This abstraction allows easy switching between providers and
 * supports multiple active providers simultaneously.
 * 
 * Example usage:
 * <pre>
...
public interface LLMProvider {
     ...
     * 
     * Returns a CompletableFuture that resolves when the complete response is ready.
     ...
     * 
     * Tokens arrive incrementally via the provided event listener.
     * Use this for real-time UI updates as text is generated.
     * 
     * @param messages Conversation messages
     ...
     * 
     * Returns models with their characteristics (context window, pricing, etc.).
     * 
     ...
     * 
     * By default, providers use a counter appropriate for their models.
