 ...
 * 
 * Implement this interface to create custom functions.
 * Functions are registered in FunctionRegistry and made available to LLMs.
 * 
 * Example:
 * <pre>
...
public interface RegisteredFunction {
    ...
    /**
     * Get function name (unique identifier).
     * Use snake_case convention (e.g., "search_projects").
     * 
     ...
     * Defines expected parameters, their types, and which are required.
     * 
