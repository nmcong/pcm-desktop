 ...
 *
 * <p>Supports: - Claude 3.5 Sonnet, Claude 3 Opus, Claude 3 Sonnet, Claude 3 Haiku - Streaming with
 * Server-Sent Events - Function/tool calling (beta) - Vision capabilities - Long context (200K
 * tokens)
 *
 * <p>API Documentation: https://docs.anthropic.com/claude/reference
 */
@Slf4j
  ...
  private String sendHttpRequest(String requestBody) throws ProviderException {
    try {
      ...
      conn.setRequestProperty(
          "x-api-key", config.getApiKey()); // Note: x-api-key, not Authorization
