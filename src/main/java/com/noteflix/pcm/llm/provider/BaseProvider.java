...
public abstract class BaseProvider implements LLMProvider {
    ...
    public boolean testConnection() {
        ...
        try {
            ...
            ChatOptions testOptions = ChatOptions.builder()
     ...
     */
    protected void validateRequest(List<Message> messages, ChatOptions options) throws ProviderException {
        ...
        if (capabilities != null && capabilities.getMaxContextWindow() > 0) {
            ...
            if (tokenCount > capabilities.getMaxContextWindow()) {
                throw new ProviderException(
                    getName(),
                    String.format("Token count (%d) exceeds context window (%d)",
