 ...
 * 
 * This is a simple approximation based on average character-to-token ratios:
 * - English: ~4 characters per token
 * - Code: ~3.5 characters per token
 * - Chinese/Japanese: ~2 characters per token
 * 
 * For production use with specific models, consider using model-specific counters.
 */
@Slf4j
