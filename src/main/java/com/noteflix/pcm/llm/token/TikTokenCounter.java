 ...
 *
 * <p>TODO: Integrate with TikToken library for accurate counting For now, this falls back to
 * DefaultTokenCounter behavior.
 *
 * <p>To enable accurate counting, add dependency: com.knuddels:jtokkit:0.6.1
 */
@Slf4j
