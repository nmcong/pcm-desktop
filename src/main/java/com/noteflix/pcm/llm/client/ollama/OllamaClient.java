 ...
 *
 * <p>Supports local models like: - Llama 2/3 - Mistral - Phi-2/3 - CodeLlama - And any other models
 * installed locally
 *
 * <p>Features: - Local inference (no API key needed) - Chat completion - Streaming responses -
 * Model management
 *
 * <p>API Docs: https://github.com/ollama/ollama/blob/main/docs/api.md
 *
 * @author PCM Team
 * @version 1.0.0
 */
