 ...
 * 
 * Provides metadata about function parameters including:
...
public @interface Param {
     ...
     * Be clear about what the parameter does and expected values.
     * 
     ...
     * If true, LLM must provide this parameter.
     * 
     ...
     * Used when parameter is optional and not provided.
     * Will be converted to parameter type.
     * 
    ...
    /**
     * Allowed enum values.
     * If specified, parameter must be one of these values.
     * 
