 ...
 * 
 * Methods annotated with @LLMFunction are automatically discovered
 * and registered in the FunctionRegistry.
 * 
 * Requirements:
 * - Method must be public
 * - Method must be in a class annotated with @FunctionProvider
 * - Parameters should be annotated with @Param for metadata
 * 
 * Example:
 * <pre>
 * &#64;FunctionProvider
...
public @interface LLMFunction {
     ...
     * If empty, uses method name converted to snake_case.
     * 
     ...
     * Disabled functions are not registered.
     * 
    ...
    /**
     * Categories/tags for this function.
     * Can be used for filtering or grouping.
     * 
