 ...
 * 
 * Classes annotated with @FunctionProvider are scanned for
 * methods annotated with @LLMFunction.
 * 
 * The class must be in the application context (managed by DI)
 * to ensure functions execute with proper dependencies.
 * 
 * Example:
 * <pre>
 * &#64;FunctionProvider
...
public @interface FunctionProvider {
     ...
     * Disabled providers are not scanned.
     * 
