 ...
 *
 * <p>Contains: - Raw result (for application use) - Display result (what to send to LLM - may be
 * summarized) - Cache metadata (was it from cache? was it summarized?)
 */
@Data
@Builder
@NoArgsConstructor
...
public class ProcessedToolResult {
  ...
  @Builder.Default private boolean fromCache = false;

  /** Was the result summarized? */
  @Builder.Default private boolean wasSummarized = false;

  /** How many tokens were saved by summarization */
  @Builder.Default private int tokensSaved = 0;
}
