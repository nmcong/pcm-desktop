 ...
 *
 * <p>Stores both the raw result and optional summarized version, along with cache metadata (TTL,
 * use count, etc.)
 */
@Data
@Builder
...
public class CachedToolResult {
  ...
  @Builder.Default private LocalDateTime cachedAt = LocalDateTime.now();

  /** Time to live (how long until expired) */
  @Builder.Default private Duration ttl = Duration.ofHours(1);

  /** How many times this cache entry was reused */
  @Builder.Default private int useCount = 0;
