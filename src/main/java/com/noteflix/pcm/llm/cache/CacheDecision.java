...
public class CacheDecision {
  ...
  @Builder.Default private boolean shouldCache = true;

  /** Should we summarize before sending to LLM? */
  @Builder.Default private boolean shouldSummarize = false;
   ...
   */
  @Builder.Default private String summarizationStrategy = "none";
