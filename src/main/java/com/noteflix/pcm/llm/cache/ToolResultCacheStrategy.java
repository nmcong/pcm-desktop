 ...
 * - AlwaysFullStrategy: Accuracy first (no summarization)
 * - SmartSummarizationStrategy: Balance accuracy vs cost
 * - TokenBudgetStrategy: Strict token limits
 * - AdaptiveStrategy: Learn from usage patterns
 */
