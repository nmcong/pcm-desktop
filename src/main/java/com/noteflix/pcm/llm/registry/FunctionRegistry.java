 ...
 * - Function execution
 * - Tool list generation for LLM requests
 * - Annotation-based auto-registration
 * 
 * This is a singleton - get the instance via getInstance().
 * 
 * Example usage:
 * <pre>
...
public class FunctionRegistry {
     ...
     * Convenience method for programmatic registration.
     * 
     ...
     * 
     * Converts registered functions to Tool objects that can be
