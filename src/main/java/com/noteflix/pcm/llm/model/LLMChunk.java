 ...
 * 
 * When streaming is enabled, responses arrive in chunks (SSE).
...
public class LLMChunk {
     ...
     * Append this to previous chunks to build full response
     */
    ...
    /**
     * Function call (for function calling with streaming)
     * May be present on last chunk if LLM wants to call a function
     */
