 ...
 * 
 * Contains the generated content, token usage statistics,
 * and optionally tool calls or thinking content.
 */
@Data
@Builder
@NoArgsConstructor
...
public class ChatResponse {
    ...
    /**
     * Response content (the actual text generated).
     * May be null if response contains only tool calls.
     */
    private String content;
    
    /**
     * Thinking/reasoning content (for reasoning models).
     * This is the internal thought process, not the final answer.
     */
    private String thinkingContent;
    
    /**
     * Tool calls requested by the LLM.
     * Can be multiple calls in a single response.
     */
