 ...
 * 
 * Tracks input tokens (prompt), output tokens (completion),
 * and optionally thinking tokens (for reasoning models).
 */
@Data
@Builder
@NoArgsConstructor
...
public class Usage {
    ...
    /**
     * Thinking/reasoning tokens (for o1/o3 models).
     * Only present in models with thinking mode.
     */
    @Builder.Default
