 ...
 *
 * <p>Defines type, description, constraints, and validation rules.
 */
@Data
@Builder
@NoArgsConstructor
...
public class PropertySchema {
  ...
  public static PropertySchema integer(String description) {
    return PropertySchema.builder().type("integer").description(description).build();
  }

  /** Create a number property. */
  public static PropertySchema number(String description) {
    return PropertySchema.builder().type("number").description(description).build();
  }
