 ...
 *
 * <p>When the LLM decides to call a function, it returns this object containing the function name
 * and arguments (as JSON string)
 *
 * <p>Example:
 *
 * <pre>
...
public class FunctionCall {
  ...
  /** Name of the function to call Example: "get_weather" */
  private String name;

  /**
   * Function arguments as JSON string
   *
   * <p>Example: "{\"location\": \"Tokyo\", \"unit\": \"celsius\"}"
   *
   * <p>Parse this JSON to get the actual arguments:
   *
   * <pre>
   ...
   */
  public <T> T parseArguments(Class<T> clazz)
  ...
  public java.util.Map<String, Object> parseArgumentsAsMap()
      throws com.fasterxml.jackson.core.JsonProcessingException {
    com.fasterxml.jackson.databind.ObjectMapper mapper =
        new com.fasterxml.jackson.databind.ObjectMapper();
