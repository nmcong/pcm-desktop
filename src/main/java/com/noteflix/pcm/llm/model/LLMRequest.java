 ...
 * Compatible with OpenAI API format for maximum compatibility
 * 
...
public class LLMRequest {
    ...
    /**
     * Model name to use
     * Examples: "gpt-4", "gpt-3.5-turbo", "claude-3-5-sonnet-20241022", "llama3"
     */
     ...
     * Range: 0.0 to 1.0
     * Example: 0.1 means only top 10% probability tokens
     */
    private Double topP;
     ...
     * Default: 1
     * Set to > 1 to get multiple responses
     */
    private Integer n;
    
    /**
     * Stop sequences
     * Generation stops when these strings are encountered
     * Example: List.of("\n", "User:", "AI:")
     */
     ...
     * Presence penalty
     * Range: -2.0 to 2.0
     * Positive values increase likelihood of new topics
     */
     ...
     * Only used if provider supports function calling
     */
     ...
     * Response will be sent in chunks (SSE)
     * Default: false
     */
    @Builder.Default
     ...
     * Allows passing custom params to specific providers
     * 
     * Example for Anthropic:
     * Map.of("max_tokens_to_sample", 1000)
     */
