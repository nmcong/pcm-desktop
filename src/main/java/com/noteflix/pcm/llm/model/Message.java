...
public class Message {
    ...
    /**
     * Tool calls (new architecture - supports multiple tool calls) Used when ASSISTANT wants to call
     * multiple tools in sequence
     */
    private java.util.List<ToolCall> toolCalls;

    /**
     * Tool call ID (for TOOL role messages) Links tool result back to the specific tool call
     */
    ...
    public static Message tool(String toolCallId, String result) {
        return Message.builder().role(Role.TOOL).toolCallId(toolCallId).content(result).build();
    }
    ...
    public static Message assistantWithTools(java.util.List<ToolCall> toolCalls) {
        return Message.builder().role(Role.ASSISTANT).toolCalls(toolCalls).build();
    }
    ...
    public enum Role {
        ...
        /**
         * Tool message (result of tool execution) Links back to a specific tool call via toolCallId
         */
        TOOL
    }
}
