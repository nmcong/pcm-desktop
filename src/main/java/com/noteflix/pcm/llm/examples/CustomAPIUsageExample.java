...
public class CustomAPIUsageExample {
    ...
    private static void example3_FunctionCalling() throws Exception {
            ...
            new com.noteflix.pcm.llm.api.RegisteredFunction() {
                ...
                public JsonSchema getParameters() {
                    return JsonSchema.builder()
                        .type("object")
                        .property("query", PropertySchema.builder()
                            .type("string")
                ...
                public Object execute(Map<String, Object> args) {
                    ...
                    return Map.of(
                        "results", List.of("Result 1", "Result 2", "Result 3"),
                        "total", 3
                    );
                }
            };
        ...
        List<Message> messages = List.of(
            Message.user("Search the database for 'quantum physics papers'")
        );
    ...
    public static void integrateWithUI() {
        ...
        List<Message> messages = List.of(
            Message.user("User's question here")
        );
