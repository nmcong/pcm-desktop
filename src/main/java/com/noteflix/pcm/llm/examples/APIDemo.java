...
public class APIDemo {
    ...
    private static void showMainMenu() {
        while (true) {
            ...
            switch (choice) {
                case "1": demoSimpleChat(); break;
                case "2": demoAdvancedRequest(); break;
                case "3": demoStreaming(); break;
                case "4": demoConversation(); break;
                case "5": showProviderInfo(); break;
                case "6": switchToGPT4(); break;
                case "7": demoFunctionCalling(); break;
                case "0": 
