 ...
 *
 * <p>Prevents exceeding API rate limits by controlling request frequency. Each provider can have
 * different limits.
 *
 * <p>Features: - Token bucket algorithm - Per-provider limits - Configurable refill rate -
 * Thread-safe
 *
 * <p>Example usage:
 *
...
public class RateLimiter {
    ...
    private TokenBucket getBucket(String provider) {
        return buckets.computeIfAbsent(provider, k -> new TokenBucket(maxTokens, refillInterval));
    }
