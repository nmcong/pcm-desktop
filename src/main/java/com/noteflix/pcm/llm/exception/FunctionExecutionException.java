 ...
 * 
 * This wraps the underlying error from function execution,
 * providing context about which function failed and why.
 * 
 * Example:
 * <pre>
 * try {
...
public class FunctionExecutionException extends LLMException {
    ...
    public FunctionExecutionException(String functionName, Object arguments, Throwable cause) {
        super(String.format("Function '%s' execution failed with args %s", functionName, arguments), cause);
        this.functionName = functionName;
