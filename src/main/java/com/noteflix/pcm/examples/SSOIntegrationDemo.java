...
public class SSOIntegrationDemo {
    ...
    private static void showMainMenu() {
        while (true) {
            ...
            switch (choice) {
                case "1": testTokenExtraction(); break;
                case "2": manualTokenInjection(); break;
                case "3": tokenCacheManagement(); break;
                case "4": checkServiceStatus(); break;
                case "5": simulateBrowserToken(); break;
                case "6": fileTokenDemo(); break;
