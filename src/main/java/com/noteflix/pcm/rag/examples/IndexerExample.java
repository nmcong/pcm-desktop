...
/**
 * Example: Indexing documents with DocumentIndexer.
 * Shows how to:
 * 1. Create indexer
 * 2. Index directory
...
public class IndexerExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            DocumentIndexer.IndexingProgress progress = indexer.indexDirectory(
                Paths.get("src/main/java/com/noteflix/pcm/rag"),
                true  // recursive
            );
