 ...
 *
 * <p>Shows how to: 1. Create offline vector store (Lucene) 2. Index documents 3. Query and get
 * results
 *
 * <p>Run this to test the RAG system!
 *
 * @author PCM Team
 * @version 1.0.0
 */
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      VectorStore vectorStore =
          VectorStoreFactory.create(VectorStoreConfig.lucene("data/rag/example-index"));
