...
/**
 * Service for indexing documents into RAG system.
 * Supports:
...
public class DocumentIndexer {
    ...
    public IndexingProgress indexDirectory(Path dirPath, boolean recursive) throws IOException {
        ...
        log.info("Directory indexing completed: {} files indexed, {} skipped, {} failed in {}ms",
            progress.getIndexedCount(), progress.getSkippedCount(), 
            progress.getFailedCount(), progress.getDuration());
    ...
    public static class IndexingProgress {
        ...
        public String toString() {
            return String.format("Indexing Progress: %d indexed, %d skipped, %d failed (total: %d) in %dms",
