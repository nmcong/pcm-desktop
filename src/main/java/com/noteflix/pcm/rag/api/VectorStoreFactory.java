 ...
 * 
 * This allows easy swapping between different implementations:
 * - LUCENE: Offline, embedded, no external dependencies
 * - QDRANT: High-performance, can run locally or remote  
