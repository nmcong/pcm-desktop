 ...
 *
 * <p>Integrates with LLMService to generate AI responses. Handles conversion between domain models
 * and LLM models.
 *
 * <p>Follows: - Single Responsibility Principle (only AI integration) - Adapter Pattern (adapts
 * domain models to LLM models) - Strategy Pattern (different LLM providers)
 *
 * @author PCM Team
 * @version 1.0.0
 */
...
public class AIService {
  ...
  public void streamResponse(
      Conversation conversation, String userMessage, StreamingObserver observer) {
