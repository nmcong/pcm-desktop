 ...
 *
 * <p>Business logic layer for chat conversations. Orchestrates operations between UI and
 * repository.
 *
 * <p>Follows: - Single Responsibility Principle (only conversation business logic) - Dependency
 * Inversion Principle (depends on repository interface) - Service Layer Pattern
 *
 * @author PCM Team
 * @version 1.0.0
 */
...
public class ConversationService {
  ...
  public Conversation createConversation(
    ...
    log.info(
        "Creating new conversation: title={}, user={}, provider={}, model={}",
        title,
        userId,
        llmProvider,
        llmModel);
  ...
  public Conversation createConversationWithSystemPrompt(
      String title, String userId, String llmProvider, String llmModel, String systemPrompt) {
