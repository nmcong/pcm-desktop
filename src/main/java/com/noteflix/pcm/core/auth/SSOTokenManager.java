...
/**
 * Manager for SSO tokens and authentication Supports multiple token sources: cookies, localStorage,
 * registry, files
 *
 * @author PCM Team
 * @version 1.0.0
  ...
  public Optional<String> getToken(String serviceName) {
    ...
    try {
      ...
      auditLogger.logSuspiciousActivity(
          "TOKEN_EXTRACTION_ERROR", "Service: " + serviceName + ", Error: " + e.getMessage());
      return Optional.empty();
    }
  }
