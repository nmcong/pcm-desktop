...
/**
 * Extracts tokens from various sources: browser cookies, localStorage, Windows registry, shared
 * files, etc.
 *
 * @author PCM Team
 * @version 1.0.0
...
public class TokenExtractor {
  ...
  public Optional<String> extractToken(String serviceName) {
    ...
    try {
      Optional<String> localStorageToken =
          localStorageExtractor.extractFromLocalStorage(serviceName);
