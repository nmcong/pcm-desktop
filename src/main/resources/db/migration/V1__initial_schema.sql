...
INSERT
OR IGNORE INTO schema_version (version, description) VALUES (1, 'Initial schema');
...
-- Default settings
INSERT
OR IGNORE INTO settings (key, value, category, description) VALUES
...
-- Default tags
INSERT
OR IGNORE INTO tags (name, color, category) VALUES
...
INSERT
OR IGNORE INTO projects (name, code, description, type, status, color) VALUES
