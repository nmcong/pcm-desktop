...
CREATE TABLE IF NOT EXISTS conversations (
    ...
    preview TEXT,
    llm_provider TEXT NOT NULL CHECK(llm_provider IN ('openai', 'anthropic', 'ollama', 'custom')),
...
INSERT OR IGNORE INTO conversations (id, title, user_id, preview, llm_provider, llm_model, message_count, created_at, updated_at)
VALUES (
    1,
...
INSERT OR IGNORE INTO messages (id, conversation_id, role, content, created_at, updated_at)
VALUES (
    1,
    1,
    'ASSISTANT',
